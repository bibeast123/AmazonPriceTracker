...
class AmazonAPI:
    ...
    def get_single_product_info(self, asin):
        ...
        self.driver.get(f'{product_short_url}?language=en_GB') #might have to change
        time.sleep(2)
    ...
    def get_price(self):
        ...
        try:
            ...
            try:
                price = self.driver.find_element_by_class_name('a-price a-text-price a-size-medium apexPriceToPay').text
                price = self.convert_price(price)
            except NoSuchElementException:
    ...
    def get_products_links(self):
        ...
        try:
            ...
            results = result_list[0].find_elements_by_xpath(f'//*[@id="search"]/div[1]/div[1]/div/span[3]/div[2]/div/div/div/div/div/div/div[1]/div/div[2]/div/span/a')
            
            #//*[@id="search"]/div[1]/div[1]/div/span[3]/div[2]/div[3]/div/div/div/div/div/div[1]/div/div[2]/div/span/a
